...
async def auth_verify(auth: AuthVerifyRequest):
    ...
    try:
        ...
        # Usiamo "dummy" per simulare la firma nel prototipo
...
# ------------------------------------------------
# ENDPOINT SPIN (Giro della Ruota)
# ------------------------------------------------
@app.post("/api/spin")
...
# ------------------------------------------------
# ENDPOINT ACQUISTO GIRI (Richiesta Istruzioni)
# ------------------------------------------------
...
# ------------------------------------------------
# ENDPOINT CONFERMA ACQUISTO GIRI (Verifica TX)
# ------------------------------------------------
