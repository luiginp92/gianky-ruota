...
import { ApiController, ChainController, ModalController, OptionsController, RouterController, SIWXUtil } from '@reown/appkit-core';
...
describe('W3mModal', () => {
    ...
    describe('Network Changes', () => {
        ...
        it('should handle network change when not connected', async () => {
            ...
            element.caipNetwork = { id: '1', name: 'Network 1', caipNetworkId: 'eip155:1' };
            const nextNetwork = {
                id: '2',
                name: 'Network 2',
